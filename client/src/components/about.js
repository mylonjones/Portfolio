...
export default function About () {
  return(<div className='about'>
    ...
    <p>
      ...
      <p>
        I aim to find a workplace where I can use creativity and problem solving to build interactive tools and applications that are ethical, valuable, and diverse. I would be in a dynamic team of results-driven engineers whom I could hang out with outside of work on occasion. It would also be ideal to someday be a mentor because I want to be as helpful to my fellow engineers as I can.
      </p>
